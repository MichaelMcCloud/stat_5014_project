####
# Working file for CRUD operations
####
...
tq_get("^VIX", from = "2023-10-01", to = "2023-10-06")

tq_get(c("SPY", "^VIX", "^NDX", "^DJI"), 
       from = "2023-10-01", 
       to = "2023-10-06") %>%
  select(-volume)
...
# 1.1 create functions for daily updates
...
write_csv(init_stock_data, file = "00_original_data/initData.cvs")
...
dump(c("get_daily_update", "save_data", "load_data"), file = "01_scripts_and_functions/CRUD_functions.R")
